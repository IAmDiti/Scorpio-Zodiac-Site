...
export function PlayHeader() {
  return (
    <header className="mx-auto flex w-full max-w-[26rem] items-center justify-between px-5 py-4">
...
export function PlayFooter() {
  return (
    <footer className="mx-auto mt-auto w-full max-w-[26rem] border-t border-line/70 px-5 py-6">
