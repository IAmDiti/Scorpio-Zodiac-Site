...
export function SiteNotice() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-line-2 bg-surface/95 backdrop-blur">
      <div className="mx-auto flex max-w-3xl flex-col gap-2.5 px-5 py-3.5 sm:flex-row sm:items-center sm:gap-4">
