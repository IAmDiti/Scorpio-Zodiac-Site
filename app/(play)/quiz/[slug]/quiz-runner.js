...
export function QuizRunner({ quiz }) {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[26rem] flex-col px-5 pb-8 pt-5 sm:max-w-xl sm:justify-center sm:py-12">
      <div className="flex flex-1 flex-col sm:flex-none sm:rounded-3xl sm:border sm:border-line sm:bg-surface/50 sm:p-8">
        {/* progress */}
        ...
        <div className="pt-8 sm:pt-6">
          ...
          <h1 className="text-[23px] text-ink-bright sm:text-[27px]">{question.q}</h1>
        </div>
        ...
        {/* nav */}
        <div className="mt-auto flex gap-2.5 pt-6 sm:mt-8">
          <button
            type="button"
