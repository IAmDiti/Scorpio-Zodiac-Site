...
export const HOROSCOPE_SCHEMA = {
  ...
  properties: {
    headline: {
      type: 'string',
      description:
        'A short, evocative title for the day: 3 to 6 words, no ending punctuation, drawn from the day\'s dominant transit. Like a magazine cover line. e.g. "The depths call today", "Say the tender thing", "Quiet power, aimed carefully".',
    },
    overview: {
      type: 'string',
      description:
...
- The headline is a short cover line (3-6 words, no ending punctuation), not a summary sentence.
