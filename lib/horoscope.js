...
import { tidyProse, tidyHeadline } from './prose.js'
...
export async function generateHoroscope(dateISO) {
  ...
  return {
    date: dateISO,
    sign: HOME_SIGN,
    headline: tidyHeadline(data.headline),
    overview: tidyProse(data.overview),
    love: tidyProse(data.love),
    career: tidyProse(data.career),
    wellbeing: tidyProse(data.wellbeing),
