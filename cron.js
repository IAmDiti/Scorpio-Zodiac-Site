...
STRUCTURE:
1. OVERALL ENERGY (2–3 sentences) — Start with a bold intrusive insight
2. LOVE & RELATIONSHIPS (2–3 sentences) — Focus on emotional tension or subtle signals
3. CAREER & AMBITION (2–3 sentences) — Focus on positioning, strategy, or hidden dynamics
4. HEALTH & BODY (1–2 sentences) — Connect physical sensation to emotional resistance
5. SPIRITUAL GUIDANCE (1–2 sentences) — Reveal a deeper truth the reader already senses
6. POWER MOVE (1 sentence) — A clear specific behavioral action, insider advice
7. FINAL LINE (1 sentence) — Cinematic, sharp, memorable, hits like a truth

STYLE REQUIREMENTS:
- At least ONE ego-trigger line (e.g. "You're not confused—you're avoiding the answer.")
- At least ONE micro-specific moment (e.g. "that pause before they answered")
- Vary themes daily — do not repeat "someone is fake"
...
Return ONLY valid JSON, no markdown:
{
  ...
  "daily_power_move":"1 sentence — specific behavioral action",
  "daily_final_line":"1 sentence — cinematic and sharp",
